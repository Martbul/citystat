...
import 'package:citystat/shared/version_checker/version_checker.dart';
import 'package:citystat/startup/tasks/app_widget.dart';
import 'package:citystat/startup/tasks/device_info_task.dart';
...
class AutoUpdateTask extends LaunchTask {
  ...
  static const _feedUrl =
      'https://github.com/AppFlowy-IO/citystat/releases/latest/download/appcast-{os}-{arch}.xml';
